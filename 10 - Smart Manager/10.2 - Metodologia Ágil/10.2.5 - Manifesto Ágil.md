...
É importante sempre realizar interesses para manter o contrato, até porque os muros de proteção em contratos não evitam a complexidade das questões.

É sempre muito importante e necessário a colaboração entre as pessoas da equipe de desenvolvimento quanto o time do cliente e dos usuários finais. É imprescindível a confiança e a colaboração entre os desenvolvedores e o cliente.

**RESPONDER ÀS MUDANÇAS**

Outro valor do manifesto ágil é responder às mudanças. Responder às mudanças é muito mais do que seguir um plano que foi levantado, documentado e executado. Isso porque o desenvolvimento de um software é um processo contínuo de aprendizado.

Responder às mudanças é um processo de aprendizado tanto das pessoas envolvidas na equipe de desenvolvimento quanto das pessoas envolvidas com o cliente no negócio e com os usuários finais do software em desenvolvimento.

Já sabemos que as mudanças são inevitáveis e vão acontecer naturalmente. Além disso é importante ver que as mudanças são as oportunidades para o desenvolvimento de um software com muito mais qualidade e que entregam os resultados que realmente suprem as necessidades tanto do cliente quanto dos usuários finais.

As mudanças, quando realizadas de forma natural vão afunilando o desenvolvimento do software de forma a gerar qualidade e entrega que realmente vão de encontro ao esperado pelo cliente. Por isso, as mudanças devem ser recebidas e acolhidas de braços abertos.

No desenvolvimento de um software, se você evitar as mudanças e as entregas parciais dos softwares funcionais, a entrega final do software pode produzir um resultado final que não necessariamente resolva o problema do cliente.

O replanejamento contínuo é importante no desenvolvimento de um software para garantir a entrega com qualidade e que resolva os problemas que o cliente busca resolver. Por isso, é importante prever e incluir ciclos em diversos níveis.

As mudanças permitem o amadurecimento do time de desenvolvimento e do cliente, gerando oportunidade de reflexão que direcionam para uma readequação do direcionamento do projeto o que garante uma maior qualidade na entrega do software.

**Atividade extra**

Nome da atividade: Imaginar e aplicar no dia a dia.

Observe o seu dia a dia e escreva três situações em que você consegue imaginar-se utilizando os conceitos do manifesto ágil.
