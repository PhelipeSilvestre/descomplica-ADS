...
O Desing Thinking é uma abordagem que está focada no ser humano. O Desing Thinking possui como características a multidisciplinaridade, a colaboração, que seja tangível de pensamentos e processos. O que encurta o caminho para soluções inovadoras nos negócios.
...
O Design Thinking tem todo o seu desenvolvimento focado nas pessoas, nas experiências das pessoas e nas necessidades que elas têm.

O Objetivo do Design Thinking é ter informações com o entendimento de culturas, experiências, emoções, pensamentos e comportamento das pessoas para o desenvolvimento das soluções.
...
No Design Thinking as informações coletadas estão relacionadas às opiniões e aos comportamentos, objetos e palavras que expressam a relação de coisas e processos do meio, agora ou futuros.
...
A pesquisa exploratória permite uma aproximação maior com o cliente e seu usuário final proporcionando um maior conhecimento das necessidades do cliente e de suas expectativas quanto a solução de seus problemas.
...
Observe o seu dia a dia e escreva três situações em que você consegue imaginar-se utilizando os conceitos de inovação e design thinking.
