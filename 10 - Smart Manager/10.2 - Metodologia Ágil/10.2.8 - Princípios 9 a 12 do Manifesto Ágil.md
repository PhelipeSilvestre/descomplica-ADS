## Princípios 9 a 12 do Manifesto Ágil
...
Com os times auto-organizáveis do manifesto ágil, é possível evitar a sistematização do desenvolvimento do software, o que evita a ocorrência de falhas, pois sistematizar o desenvolvimento do software tende a ser falha.
...
As reflexões regulares é um dos princípios do manifesto ágil. Entender cada fase do desenvolvimento e o comportamento de cada membro da equipe leva a reflexões que devem ser regulares para manter o time em equilíbrio e harmonia.

A reflexão do time deve acontecer em intervalores regulares. Essas reflexões regulares sobre como se tornar mais eficaz, permite um ajustamento nos comportamentos dos membros da equipe, o que leva a manutenção do equilíbrio e da harmonia no desenvolvimento.

Os processos por mais que detalhados e testados, estão longe de serem perfeitos. Os processos perfeitos inexistem. E, cada equipe, cada projeto deve encontrar, por méritos próprios, sua própria dinâmica de trabalho. Isso é natural. As pessoas mudam em cada equipe de desenvolvimento.

As reflexões regulares são importantes no manifesto ágil pois inexiste regras que são preestabelecidas. O importante é sempre manter uma única regra básica, que é o de melhoria contínua de cada membro da equipe e no desenvolvimento do software.

As reflexões regulares podem acontecer a cada ciclo, ou sobre o que foi feito, ou aprender com o que não funcionou e potencializar o que estiver dando certo. Muito aprendizado vai acontecer nas primeiras interações do projeto, depois passam a ser mais harmônicas.

Com as reflexões regulares do método ágil, acontece uma convergência no ritmo de desenvolvimento, nas expectativas e prioridade dos envolvidos. Além disso, reforça o potencial de sustentabilidade dos trabalhos no desenvolvimento do software.

**Atividade extra**

Nome da atividade: Imaginar e aplicar no dia a dia.

Observe o seu dia a dia e escreva três situações em que você consegue imaginar-se utilizando os princípios 9 a 12 do manifesto ágil.
