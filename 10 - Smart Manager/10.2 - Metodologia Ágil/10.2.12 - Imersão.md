...
Serão apresentados a seguir os conceitos de design thinking e imersão em profundidade, bem como, sua importância no desenvolvimento de software. Serão apresentadas a importância e a necessidade das entrevistas, das sessões generativas e de um dia na vida.
...
Há quatro perguntas que devem ser respondidas quando se faz a imersão em profundidade, para a descoberta de detalhes para o projeto: o que as pessoas falam, como as pessoas agem, o que as pessoas pensam e como as pessoas se sentem.
...
A entrevista é uma das ferramentas utilizadas para se realizar a imersão em profundidade. A entrevista acontece por meio de conversa com o cliente ou usuário final, em um bate papo com perguntas em relação ao assunto que está sendo pesquisado e à rotina de vida destas pessoas.

As entrevistas têm por objetivo buscar e entender a história das experiências de vida do cliente e do usuário final. É importante que a entrevista instigue e encontre respostas para os por quês, pois o significado do que está sendo falado é muito mais importante do que a resposta em si.
...
Pode-se utilizar o caderno de sensibilização na sessão degenerativa para se obter uma reflexão do usuário e do cliente final sobre suas memórias, seus sentimentos e suas motivações.
...
O objetivo de um dia na vida é ter uma visão da vida do cliente e do usuário final sob outra perspectiva. Neste caso, alguém da equipe se coloca no papel do cliente ou do usuário final e vive a experiência de um dia com as informações coletadas pelas pesquisas realizadas.
...
Observe o seu dia a dia e escreva três situações em que você consegue imaginar-se utilizando os conceitos de imersão.

**Referência Bibliográfica**

BROWN, T. Design Thinking – Editora Alta Books. 1ª Edição. 2017.

DORNELAS, J.; Bim, A.; FREITAS, G.; USHIKUBO, R. Plano de Negócios com o Modelo Canvas: guia prático de avaliação de ideias de negócios a partir de exemplos –Editora LTC. 1a Edição. 2017.