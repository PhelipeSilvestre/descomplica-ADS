...
O processo criativo do brainstorming é conduzido por um moderador que vai direcionando os participantes a gerarem as ideias com as sugestões e seguindo uma direção adequada para o novo software a ser criado.
...
Este tipo de atividade de workshop de cocriação é bastante útil e utilizada em momento de impasse no desenvolvimento do software, quando são necessárias novas versões de ideias para eliminar os impasses e continuar com o desenvolvimento inovador.
...
Observe o seu dia a dia e escreva três situações em que você consegue imaginar-se utilizando os conceitos de Ideação.
