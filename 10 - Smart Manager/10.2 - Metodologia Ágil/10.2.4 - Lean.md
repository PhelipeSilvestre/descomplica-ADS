...
Outro princípio da metodologia Lean é a integração da qualidade, desde o início ao fim do projeto. É possível garantir a qualidade na criação do software por meio de técnicas como os testes unitários para prevenção e detecção de defeitos.

Pode-se também desenvolver o software ordenando, sistematizando, limpando, padronizando, mantendo o necessário. Isso significa que você melhora e refina o código, integrando de forma contínua e mantendo a qualidade.

A forma de criar e ampliar o conhecimento é outro princípio da abordagem Lean importante, pois por meio da experimentação, acontece a melhoria contínua dos processos internos, priorizando a comunicação e o retorno contínuo entre os times de desenvolvimento e os usuários do cliente, durante todo o processo de software.

Outro princípio importante da abordagem Lean é o adiamento dos comprometimentos, isso significa que quanto mais tardio as decisões foram tomadas, mais assertivas elas passam a ser, pois as decisões tomadas no último momento permitem ter mais informações e experiências para fortalecer a tomada de decisão.

**ÚLTIMOS PRINCÍPIOS  
**

A entrega rápida é outro princípio da abordagem Lean que entende que a velocidade é sinônimo da ausência de desperdício, por isso, a importância de se utilizar práticas ágeis. A convivência com horas extras não é sustentável, pois estamos lidando com pessoas.

As entregas rápidas permitem maximizar o retorno do investimento do projeto de software, de forma a entregar um software de valor agregado de forma rápida e contínua.

O respeito às pessoas é mais um dos princípios da abordagem Lean, pois entende-se que as pessoas é o capital mais importante de uma organização de um projeto de software. A ideia é ter um ambiente onde o time trabalhe numa forma de gerenciamento auto-organizado e autodirigido, num ambiente sustentável, evitando o micro gerenciamento.

E por fim, temos a otimização do todo como um dos princípios da abordagem Lean, onde se é possível utilizar métricas corretas para medir, analisando os resultados, entendendo bem o software como um todo, que quando terminado, não é apenas uma soma de partes que foram desenvolvidos, mas que o software como um todo agrega valor aos objetivos do cliente.

A abordagem Lean é simples de se entender, porém, pode ser mais complicado de efetivamente implementar porque é necessária uma mudança de mindset das pessoas, do time do cliente e da equipe de desenvolvimento, passa a ser necessário uma mudança de cultura da própria empresa.

**Atividade extra**

Nome da atividade: Imaginar e aplicar no dia a dia.

Observe o seu dia a dia e escreva três situações em que você consegue imaginar-se utilizando os conceitos do método Lean Thinking.
