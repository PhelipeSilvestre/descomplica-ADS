...
Serão apresentados a seguir os conceitos dos métodos ágeis como o scrum e o kanban, como entender e diferenciar scrum de kanban e como saber aplicar scrum e kanban de forma associativa.

**SCRUM**

O Scrum é uma ferramenta muito utilizada na metodologia ágil e é utilizada na gestão de projetos em qualquer área ou setor e é utilizada também para o desenvolvimento de software com muitos bons resultados, lembrando sempre que o objetivo é entregar o que o cliente espera resolver suas necessidades.
...
É importante saber que o Produto Backlog é o conjunto de objetivos do projeto ou pacotes de funcionalidades a serem desenvolvidas no software quando a gestão do projeto está utilizando o Scrum como ferramenta do método ágil.

O Sprint backlog são as tarefas específicas que serão realizadas e desenvolvidas em cada ciclo ou sprint, que deve ser uma parte diário, uma parte semanal e uma parte mensal, quando o Scrum está sendo considerado.

O Sprint é o ciclo de cada projeto e o working increment of the software é o desenvolvimento de trabalho em equipe. São nomenclaturas muito utilizadas e conhecidas quando se desenvolve software com o Scrum.
...
O Kanban é uma ferramenta muito utilizada na metodologia ágil e é utilizada na gestão de projetos em qualquer área ou setor e é utilizada também para o desenvolvimento de software com muitos bons resultados, lembrando sempre que o objetivo é entregar o que o cliente espera resolver suas necessidades.
...
Com o Kanban, as atividades passam de cada etapa até serem entregues, faz parte de uma metodologia ágil e o Kanban é utilizado na gestão de projetos. E passou a ser muito bem utilizado e aceito no desenvolvimento de projetos de software.

A seguir, temos um exemplo de como o Kanban é utilizado e de uma forma visual de forma que todos da equipe consigam ter o entendimento de todo o projeto.

![](https://paperx-dex-assets.s3.sa-east-1.amazonaws.com/images/1641404137894-Uh1MNIPKKT.png)
...
Em relação ao fluxo, o Kanban possui um fluxo mais contínuo e o Scrum possui sprints regulares bem definidos.
...
Tanto o Scrum quanto o Kanban podem ser aplicados juntos ou separados como ferramentas das metodologias ágeis para o desenvolvimento e criação de software de qualidade que satisfazem as necessidades do cliente.
...
O desenvolvimento deve ser organizado e separado em pelo menos três partes, o “***to do***” que é o que precisa ser feito, o “***doing***” que é o que está sendo feito e o “***done***” que é o que já foi feito no projeto de desenvolvimento do software…

**Atividade extra**

Nome da atividade: Imaginar e aplicar no dia a dia.

Observe o seu dia a dia e escreva três situações em que você consegue imaginar-se utilizando os conceitos de scrum e kanban
