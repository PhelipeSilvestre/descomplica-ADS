...
Uma referência polimórfica é uma variável que pode se referir a diferentes tipos de objetos em diferentes momentos. Normalmente é compatível com a classe a que se refere. Por exemplo, considere a declaração ***Empregado emp;****.*
...
![Figura 1 – Relação de herança entre a subclasse Cilindro e a superclasse Círculo Fonte: Elaborado pelo autor](https://paperx-dex-assets.s3.sa-east-1.amazonaws.com/images/1670361964249-OxEVP6nu6Q.png)
