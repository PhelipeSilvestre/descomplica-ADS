...
![Figura 2 - Rua representando uma memória com variáveis simples e compostas Fonte: Elaborado pelo autor](https://paperx-dex-assets.s3.sa-east-1.amazonaws.com/images/1670422569256-AZlr5IV9d4.png)
...
| 1 | double\[\] notasCarlos = new double\[4\]; |
| --- | --- |
| 2 | double media; |
| 3 |  |
| 4 | notasCarlos\[0\] = 4; |
...
| 7 | notasCarlos\[3\] = 8; |
| 8 |  |
| 9 | media = (notasCarlos\[0\] + notasCarlos\[1\] + notasCarlos\[2\] + notasCarlos\[3\])/4; |
| 10 |  |
| 11 | System.out.println(“A média de notas do Carlos é: “ + media); |
...
| 1 | double\[\] notasCarlos = {4, 8, 6, 8} |
| --- | --- |
| 2 | double media; |
| 3 |  |
| 4 | media = (notasCarlos\[0\] + notasCarlos\[1\] + notasCarlos\[2\] + notasCarlos\[3\])/4; |
| 5 |  |
| 6 | System.out.println(“A média de notas do Carlos é: “ + media); |
...
![Figura 2 - Array unidimensional ou vetor Fonte: Elaborado pelo autor (2021)](https://paperx-dex-assets.s3.sa-east-1.amazonaws.com/images/1670422608697-QK8NKLLDXN.png)
...
| ... | ... |
| --- | --- |
| 3 | System.out.println(“Idade “, idade\[0\]); |
| 4 | System.out.println(“Idade “, idade\[1\]); |
| 5 | System.out.println(“Idade “, idade\[2\]); |
| 6 | System.out.println(“Idade “, idade\[3\]); |
| 7 | System.out.println(“Idade “, idade\[4\]); |
| ... | ... |
...
| 1 | int idade\[\] = {16,18,14,19,22,20,16,15,17,19}; |
| --- | --- |
| 2 |  |
| 3 | for(int **i** = 0; **i** < 10; **i**++){ |
| 4 | System.out.println(“Idade: ” + idade\[**i**\]); |
| 5 | } |
...
![Figura 3 – Uma estrutura de dados do tipo matriz ou array multidimensional Fonte: Elaborado pelo autor.](https://paperx-dex-assets.s3.sa-east-1.amazonaws.com/images/1670422656837-2SVzm4tdVi.png)
...
Existem três características principais de um vetor: 
...
Você pode compreender mais sobre vetores acessando a documentação oficial do Java presente na sessão The Java™ Tutorials, no site da Oracle.
